  ...
  <footer class="container-fluid p-3 fs-3 footer">
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-10 col-md-4 col-lg-4 p-3">
        ...
        <ul>
          <li class="fs-5">
            <i class="bi bi-telephone-fill fs-4"></i> 02-2701 0928<br />
            (週一至週五12:00 ~ 18:30)
          </li>
          <li class="fs-5">
            <i class="bi bi-envelope-fill"></i> core@codedriven.org
          </li>
          <li class="fs-5">
            <i class="bi bi-geo-alt-fill"></i> 台北市大安區復興南路一段360號3樓
          </li>
        </ul>
      </div>
    </div>
    ...
    <footer class="text-center">
      © 2022 by 程式驅動 | 本站所有素材引用至 Mojang 旗下遊戲 Minecraft
    </footer>
  </footer>
</template>
...
.footer {
  background: linear-gradient(rgba(63, 59, 59, 0.5) 0%, rgba(0, 0, 0, 0.9) 65%),
